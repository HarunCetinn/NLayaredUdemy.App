...
namespace NLayer.Repository.Migrations
{
    ...
    [Migration("20220719180713_Initial")]
            ...
            modelBuilder.Entity("NLayer.Core.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CategoryId = 1,
                            CreatedDate = new DateTime(2022, 7, 19, 21, 7, 13, 91, DateTimeKind.Local).AddTicks(8124),
                            Name = "kalem 1",
                            Price = 100m,
                            Stock = 20
                        },
                        new
                        {
                            Id = 2,
                            CategoryId = 2,
                            CreatedDate = new DateTime(2022, 7, 19, 21, 7, 13, 91, DateTimeKind.Local).AddTicks(8138),
                            Name = "kitap 2",
                            Price = 10m,
                            Stock = 500
                        },
                        new
                        {
                            Id = 3,
                            CategoryId = 1,
                            CreatedDate = new DateTime(2022, 7, 19, 21, 7, 13, 91, DateTimeKind.Local).AddTicks(8139),
                            Name = "kalem 3",
                            Price = 50m,
                            Stock = 80
                        });
